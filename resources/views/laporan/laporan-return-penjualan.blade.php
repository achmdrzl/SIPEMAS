                ...
                <div class="emailapp-content">
                    <div class="emailapp-single-email">
                        <header class="email-header mt-2">
                            ...
                            <div>
                                <h4>Laporan Rekap Return Penjualan</h4>
                                <div class="d-flex">
                                    <h6>Periode :</h6>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="form-print">
                                ...
                                <button type="button" class="btn btn-primary float-end" id="submit-print" data-jenis="rekap-returnpenjualan"
    ...
    <script>
        $(document).ready(function() {
            ...
            var transaksiReturnPenjualan = $('#datatable_7').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('laporan.returnPenjualan.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
