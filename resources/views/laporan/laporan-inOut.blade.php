                ...
                <div class="emailapp-content">
                    <div class="emailapp-single-email">
                        <header class="email-header mt-2">
                            ...
                            <div>
                                <h4>Laporan Rekap Pendapatan / Pengeluaran Lain</h4>
                                <div class="d-flex">
                                    <h6>Periode :</h6>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="form-print">
                                ...
                                <button type="button" class="btn btn-primary float-end" id="submit-print" data-jenis="rekap-inOut"
...
@push('script-alt')
    <script>
        $(document).ready(function() {
            ...
            var transaksiInOut = $('#datatable_7').DataTable({
                scrollX: true,
                autoWidth: false,
                language: {
                    search: "",
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('laporan.inOut.index') }}",
               columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            $('.show-data').on('click', function() {
                ...
                transaksiInOut.one('preDraw', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.data.length > 0) {
                            ...
                            transaksiInOut.destroy();

                            // Reinitialize the DataTable with the updated data
                            transaksiInOut = $('#datatable_7').DataTable({
                                scrollX: true,
                                autoWidth: false,
                                language: {
                                    search: "",
            ...
            $('body').on('click', '#submit-print', function(){
                ...
                if(format_print === null){
                    ...
                    var url = "{{ route('cetak.inOut') }}?" + queryString;
