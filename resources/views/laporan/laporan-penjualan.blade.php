                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form id="form-print">
                                ...
                                <button type="button" class="btn btn-primary float-end" id="submit-print" data-jenis="rekap-penjualan"
    ...
    <script>
        $(document).ready(function() {
            ...
            var transaksiPenjualan = $('#datatable_7').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('laporan.penjualan.index') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
