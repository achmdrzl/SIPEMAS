                    ...
                    @foreach($returnpenjualans as $item)
                        {{-- @foreach($item->returndetail as $detailItem) --}}
                            <tr>
                                ...
                                <td style="width:100px">{{ $item->returndetail->barang->barang_nama }}</td>
                                <td>{{ $item->returndetail->detail_penjualan_return_berat }}</td>
                                <td style="text-align: right">Rp.{{ number_format($item->returndetail->detail_penjualan_return_harga_return) }}</td>
                            </tr>
                            @php
                                $groupTotal += $item->returndetail->detail_penjualan_return_harga_return;
                                $totalGrandTotal += $item->returndetail->detail_penjualan_return_harga_return;
                            @endphp
                        {{-- @endforeach --}}
