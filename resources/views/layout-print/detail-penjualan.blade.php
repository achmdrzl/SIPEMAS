                    ...
                    @foreach($penjualans as $item)
                        @foreach($item->penjualandetail as $detailItem)
                            <tr>
                                ...
                                <td style="text-align: right">Rp.{{ number_format($detailItem->detail_penjualan_diskon) }}</td>
                                <td style="text-align: right">Rp.{{ number_format($detailItem->detail_penjualan_jml_harga) }}</td>
                            </tr>
                            @php
