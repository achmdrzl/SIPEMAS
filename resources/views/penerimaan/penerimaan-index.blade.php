                ...
                <div class="d-flex">
                    <div class="d-flex flex-wrap justify-content-between flex-1">
                        <div class="mb-lg-0 mb-2 me-8">
                            <h1 class="pg-title">Transaksi Penerimaan Barang</h1>
                ...
                <ul class="nav nav-line nav-light nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#data_penjualan">
                            <span class="nav-link-text">Data Penerimaan Barang</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#input_penjualan">
                            <span class="nav-link-text">Input Penerimaan Barang</span>
                        </a>
                    </li>
                </ul>
            </div>
                                                ...
                                                <div class="card card-border mb-0 h-100">
                                                    <div class="card-header card-header-action">
                                                        ...
                                                        <div class="card-action-wrap">
                                                            <button
                                                                class="btn btn-sm btn-primary ms-3 create-penerimaan-barang"><span><span
                                                                        class="icon"><span class="feather-icon"><i
                                                                                data-feather="plus"></i></span></span><span
                                                                        class="btn-text">Tambah Penerimaan Barang</span></span></button>
                                                        </div>
                                                    </div>
                                                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.show-data').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('filtered.data.penerimaan') }}",
                    data: {
                        startDate: startDate,
                        endDate: endDate,
                    },
            ...
            //  CREATE DATA PENERIMAAN.
            $('.create-penerimaan-barang').click(function() {
                $('.alert').hide();
                $('#saveBtn').val("create-barang");
                $('#penerimaanForm').trigger("reset");
                $('#tambahpenerimaanHeading').html("TAMBAH DATA PENERIMAAN BARU")
                ...
                var submitPenerimaan = $('#submitPenerimaan');
                submitPenerimaan.removeClass('edit');
                            ...
                            $.each(response, function(index, value) {
                                ...
                                listbarang += `<tr>
                                                    ...
                                                    <td><input class="form-control barang_berat" type="number" value="` + barangberat + `"
                                                            placeholder="Berat Kembali" name="detail_pengeluaran_berat_kembali[]" step="0.05" /></td>
                                                    <td>
                                                        ...
                                                        <select class="form-select return_kondisi" name="detail_pengeluaran_kondisi[]">
                                                            ...
                                                            <option value="BLM_DIPAJANG">Blm Dipajang</option>
                                                        </select>
                                                    </td>
                                                </tr>`;
            ...
            $('body').on('click', '#edit-penerimaan', function() {
                ...
                var submitPenerimaan = $('#submitPenerimaan');
                submitPenerimaan.addClass('edit');
                             ...
                             detailListBarang += `<tr>
                                                     ...
                                                     <td>
                                                        ...
                                                        <input class="form-control barang_berat" type="number" value="` + barangberatkembali + `"
                                                            placeholder="Berat Kembali" name="detail_pengeluaran_berat_kembali[]" step="0.05" />
                                                    </td>
                                                     <td>` + kondisi + `</td>
                                                 </tr>`;
                        });
            ...
            // DELETE PENERIMAAN
            $('body').on('click', '#delete-penerimaan', function() {
                ...
                var penerimaan_id = $(this).attr('data-id');
                ...
                swalWithBootstrapButtons
                    ...
                    .then((result) => {
                        if (result.value) {
                            $.ajax({
                                type: "POST",
                                url: "{{ route('penerimaan.destroy') }}",
                                data: {
                                    pengeluaran_id: penerimaan_id,
                                },
                                dataType: "json",
                                success: function(response) {
                                    const Toast = Swal.mixin({
